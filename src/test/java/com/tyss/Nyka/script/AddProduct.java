...
public class AddProduct extends Filelib{
	...
	public static void main(String[] args) throws IOException, InvalidFormatException, InterruptedException {
		...
		wb.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'"+filter1range+"')]"))).click();
		...
		wb.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'"+filter2range+"')]"))).click();
		//d.findElement(By.xpath("")).click();
